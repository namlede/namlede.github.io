...
I'm a fourth year PhD student in Harvard's [Theory of Computation](https://toc.seas.harvard.edu/) and [Machine Learning Foundations](https://mlfoundations.org/) groups. I'm advised by [Leslie Valiant](http://people.seas.harvard.edu/~valiant/) and [Sham Kakade](https://sham.seas.harvard.edu/), and supported by an NSF Graduate Research Fellowship. Previously, I undergraduated in math at Princeton.
